...
class Resize(object):
    ...
    def __init__(self,
        ...
        if img_scale is None:
            ...
            if isinstance(img_scale, list):  # 对于image_scale=(512,512) 这种情况, 这里判断不成立
    ...
    def _random_scale(self, results):
        ...
        if self.ratio_range is not None:  # 如果ratio_range不是None的情况
        ...
        elif len(self.img_scale) == 1:  # 如果ratio_range是None, 且img_scale 数组中 只有一个hw 元组
...
class RandomCrop(object):
    ...
    def __call__(self, results):
        ...
        results['crop_bbox'] = crop_bbox  # 记录 当前的crop 框
        return results
...
class PhotoMetricDistortion(object):
    ...
    def __call__(self, results):
        ...
        """
        img = results['img']
        img = self._inner_call(img)
        results['img'] = img
        return results

    def _inner_call(self, img):
        # random brightness
