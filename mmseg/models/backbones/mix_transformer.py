...
class MixVisionTransformer_(BaseModule):
...
@BACKBONES.register_module()
class mit_b0(MixVisionTransformer_):
...
@BACKBONES.register_module()
class mit_b1(MixVisionTransformer_):
...
@BACKBONES.register_module()
class mit_b2(MixVisionTransformer_):
...
@BACKBONES.register_module()
class mit_b3(MixVisionTransformer_):
...
@BACKBONES.register_module()
class mit_b4(MixVisionTransformer_):
...
@BACKBONES.register_module()
class mit_b5(MixVisionTransformer_):
