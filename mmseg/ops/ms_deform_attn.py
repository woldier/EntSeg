# -*- coding:utf-8 -*-
"""
 @FileName   : ms_deform_attn.py.py
 @Time       : 10/23/24 3:13 PM
 @Author     : Woldier Wong
 @Description: Modified from https://github.com/chengdazhi/Deformable-Convolution-V2-PyTorch/tree/pytorch_1.0.0
"""
import warnings
...
def ms_deform_attn_core(value, value_spatial_shapes, sampling_locations, attention_weights):
    ...
    value_spatial_shapes = value_spatial_shapes.cpu().numpy()
